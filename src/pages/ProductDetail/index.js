...
import { ImgWrapper, Img, DetailsWrapper, Price, Description, Wrapper } from './styled'
...
// when I get the product, I no longer need loading and have null
  ...
  componentDidUpdate(prevProps){
    const {productId} = this.props.match.params;
    if (this.props.match.params.productId !== productId){
      this.fetchProduct(productId);
    }
  }
    ...
    return(
      <Wrapper>
        ...
        {product && (
          <>
          <ImgWrapper>
            <Img src={product.data.attributes.img_url}></Img>
          </ImgWrapper>
          <DetailsWrapper>
            <H1 textAlign="center">
